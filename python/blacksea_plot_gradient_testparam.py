...
filelist1 = sorted(glob.glob(resdir+resbasename+'*'))
for i in range(0,len(filelist1)):
    ...
    figname=os.path.basename(file2load1)[:-3]
    print figname
    ...
    plt.savefig(figdir+figname+figtype, dpi=resolution, facecolor='w', edgecolor='w',
